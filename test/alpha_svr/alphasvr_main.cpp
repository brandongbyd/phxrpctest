...
void Dispatch(const phxrpc::BaseRequest &req,
    ...
    AlphaSvrServiceImpl service(*service_args);
    AlphaSvrDispatcher dispatcher(service, args);

    phxrpc::BaseDispatcher<AlphaSvrDispatcher> base_dispatcher(
            dispatcher, AlphaSvrDispatcher::GetURIFuncMap());
